...
public class ActualWorkloads {
	...
	public ActualWorkloads() {}
	
	public ActualWorkloads(int educationalLoadMcId, String name, int semester, String hours, String interactiveHours,
