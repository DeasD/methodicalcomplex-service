...
public class ActualCompetences {
	...
	public ActualCompetences() {}

	public ActualCompetences(String abbreviation, String name, String knowledge, String ability, String skill,
